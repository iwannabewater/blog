...
中文正文使用霞鹜文楷，英文正文使用 Lora。它们都有足够的人文气质，也能在长段落里保持耐读。Hero Display 使用 Cormorant Garamond 与霞鹜文楷，强调高对比度和轻重量；UI 信息交给 Comic Neue 与霞鹜文楷，避免元信息抢走正文的注意力。
...
export const principle = {
  ...
  typography: ["LXGW WenKai", "Lora", "Comic Neue", "Victor Mono"],
};
```
