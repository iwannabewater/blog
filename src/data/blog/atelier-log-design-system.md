...
中文正文使用霞鹜文楷，英文正文使用 Lora。它们都有足够的人文气质，也能在长段落里保持耐读。Hero Display 使用霞鹜文楷与 Cormorant Garamond，强调高对比度和轻重量；UI 信息交给 Noto Sans SC 与 Inter，避免元信息抢走正文的注意力。

代码使用 JetBrains Mono。它的任务不是装饰，而是保持括号、缩进、数字和标点在技术文章里清晰可辨。
...
export const principle = {
  ...
  typography: ["LXGW WenKai", "Lora", "Inter", "JetBrains Mono"],
};
```
