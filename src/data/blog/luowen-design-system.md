...
中文正文使用霞鹜文楷，中文题签、封面和引用使用仓耳金楷。左上品牌字使用杨任东竹石体。英文正文与标题优先使用 Charter，导航、标签和按钮交给 Comic Neue，代码区使用 JetBrains Mono。唯一英文手写标语使用 Caveat。日文短句优先使用系统里的 YuMincho，缺字时只回到已允许的中文字体。
